...
function statusBar(){
     var registro = JSON.parse(localStorage.getItem('pughpharm'));
        try{
            ...
            $("#sesionUsuario .nombreUsuario").html(""+registro.nombre);
         ...
         $.ajax({
            ...
            success: function(data){
                ...
                if(data.error!=''){
                    ...
                    $("#alertaRegistro").html('<i class="fa fa-warning fa-lg"></i>&nbsp;Este correo electrónico ya esta registrado.').show();
                }else{
                    pedido_scr(0);
